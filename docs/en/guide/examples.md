...
*   [Day-Boundary Rebalance Example](https://github.com/akfamily/akquant/blob/main/examples/strategies/05_stock_momentum_rotation_timer.py): Demonstrates the previous-snapshot semantics of `on_daily_rebalance` for day-boundary preparation and one-shot rebalance.
*   [After-Bar Rebalance Example](https://github.com/akfamily/akquant/blob/main/examples/strategies/09_stock_momentum_rotation_after_bar.py): Demonstrates how `on_daily_rebalance_after_bar` rebalances after the first complete cross-symbol slice of the trading day.
