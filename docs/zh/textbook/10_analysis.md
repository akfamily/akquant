...
- 函数式孪生示例：[examples/textbook/ch10_analysis_functional.py](https://github.com/akfamily/akquant/blob/main/examples/textbook/ch10_analysis_functional.py)
...
python examples/textbook/ch10_analysis_functional.py
```
